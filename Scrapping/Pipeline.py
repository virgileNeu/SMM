...
filename_address_dic = "AddressDictionary"
...
def completeGeographicData(dataframe,AddressDic=None,LocalityDic=None,CoordinatesDic=None):
	...
	if(AddressDic==None or LocalityDic==None or CoordinatesDic==None):
		...
		try:
			AddressDic = LU.loadDictionary(filename_address_dic,PATH_DIC,encoding)
		except:
			print("Can't find the dictionary of addresses.")
			AddressDic={}
		
		try:
			LocalityDic = LU.loadDictionary(filename_locality_dic,PATH_DIC,encoding)
		except:
			print("Can't find the dictionary of localities.")
			LocalityDic={}
		
		try:
			CoordinatesDic = LU.loadDictionary(filename_coordinates_dic,PATH_DIC,encoding)
		except:
