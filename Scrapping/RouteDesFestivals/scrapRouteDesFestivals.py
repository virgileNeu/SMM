...
# Download swiss festivals from website RouteDesFestivals.com, and put data
# in CSV files, in folder 'RDF-Data-Per-Festival', one file per festival.
...
if __name__ == '__main__':
    ...
    for f in swissFestivals:
        ...
        FOLDER_NAME = 'RDF-Data-Per-Festival'
